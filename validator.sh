...
# Usage:
#    1. Open Terminal
#    2. CD to this file location and run ./validator.sh
#    Ex: cd /Users/<user1>/<project directory>/Utilities/Localization Validator
#        ./validator.sh
#

HOME_DIR=$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )

project_name="WyndhamRewards"
development_file="$HOME_DIR/../../$project_name/Supporting Files/Localizable.strings"
echo "*** Project localizable strigs $development_file"
